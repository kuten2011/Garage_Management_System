-- ==========================================================
-- FULL DATABASE INIT - SCHEMA(6) + DATA(6)
-- PostgreSQL
-- Cách chạy cho database mới/trống:
--   psql -U <user> -d <database> -f garage_full_schema_data.sql
-- Lưu ý: cần cài pgvector nếu dùng cột vector(768).
-- ==========================================================
